...
import com.yanwu.spring.cloud.common.service.QuoteRoService;
 ...
 */
public abstract class BaseRoRestControllerAbsreact<VO extends ValueObject, DO extends BaseObject, SERVICE extends QuoteRoService<DO>>
    ...
    public ResponseEntity<ResponseEnvelope<List<VO>>> findByIdsOrOwnerIds(
            ...
            @PageableDefault Pageable pageRequest) throws Exception {
    ...
    protected ResponseEntity<ResponseEnvelope<List<VO>>> findByOwnerIds(Set<Long> ownerIds, Pageable pageRequest)
            throws Exception {
