...
public enum DeviceRegexEnum {
    ...
    SCREEN_REGEX("screen", "(?<head>\\w{2})(?<deviceNo>\\w{4})(?<code>\\w{2})(?<data>\\w*)(?<end>\\w{2})(?<crc>\\w{4})", ScreenBaseBO.class),
    /*** 报警灯正则表达式：【帧头：2字节；SN：6字节；消息序列号：2字节；主命令字：1字节；子命令字：1字节；帧尾：2字节；校验码：2字节】 ***/
    ALARM_LAMP_REGEX("alarmLamp", "(?<head>\\w{4})(?<sn>\\w{12})(?<seq>\\w{4})(?<mcode>\\w{2})(?<ccode>\\w{2})(?<data>\\w*)(?<end>\\w{4})(?<crc>\\w{4})", AlarmLampBaseBO.class),
    ;
