 ...
 * @date 2020-07-06 21:29:20.
 * <p>
 * describe:
 */
@Data
@Slf4j
public class S02LinkedQueue<E extends Serializable> {
    private int top;
    private final int size;
    private Node<E> left;
    private Node<E> right;

    public S02LinkedQueue(int size) {
        this.top = -1;
        this.size = size;
        this.left = null;
        this.right = null;
    ...
    public static void main(String[] args) {
        S02LinkedQueue<Integer> queue = new S02LinkedQueue<>(5);
