...
public class Sender {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DefaultMQProducer producer = new DefaultMQProducer("HZConsumerTest");
        // ----- 指定nameServer地址
...
//        for (int i = 0; i < 100; i++) {
            ...
            messageBO.setMessageId(String.valueOf(111)).setData("hello message: " + 111)
                    .setCreate(new Timestamp(System.currentTimeMillis()));
            // ----- topic: 主题; tag: 标签; keys: 关键字; body: 消息内容;
            Message message = new Message("Daily-Control-Dn", "appDomain", String.valueOf(111), JsonUtil.toJsonString(messageBO).getBytes());
            // ----- 发送消息并返回结果
