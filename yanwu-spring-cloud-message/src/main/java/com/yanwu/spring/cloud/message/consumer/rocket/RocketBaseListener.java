 ...
 */
@Slf4j
@Service("baseListener")
public class RocketBaseListener implements WrapperMessageListener {

    @Override
    public ConsumerActionEnum consume(WrapperMessage message) {
        log.info("base listener, topic: {}, target: {}, key: {}, body: {}", message.getTopic(), message.getTag(), message.getKey(), message.getBody());
