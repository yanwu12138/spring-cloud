...
public class RedisLockUtil {
    ...
    private ValueOperations<String, Long> lockOperations;
     ...
     */
    public void lock(String key, Long value) {
     ...
     */
    public void lock(String key, Long value, Integer timeout) {
    ...
    private boolean tryLock(String key, Long value, Integer timeout) {
        Boolean result = lockOperations.setIfAbsent(key, value, timeout, TimeUnit.SECONDS);
