...
//            messageBO.setMessageId(String.valueOf(i)).setData("hello message: " + i).setType("test").setCreate(new Timestamp(System.currentTimeMillis()));
//            // ----- topic: 主题; tag: 标签; keys: 关键字; body: 消息内容;
//            Message message = new Message("yanwu_topic", "yanwu_tag", String.valueOf(i), JsonUtil.toCompactJsonString(messageBO).getBytes());
//            // ----- 发送消息并返回结果
